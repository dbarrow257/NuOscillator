...
int main(int argc, char **argv) {
  ...
  //test values for Sterile+1 model
  std::vector<FLOAT_T> OscParams_Atm_OscProb(12);
  ...
  OscParams_Atm_OscProb[6] = 0.;
  OscParams_Atm_OscProb[7] = 0.03;
  OscParams_Atm_OscProb[8] = 0.05;
  OscParams_Atm_OscProb[9] = 1.;
  OscParams_Atm_OscProb[10] = 2.;
  OscParams_Atm_OscProb[11] = 1.;
